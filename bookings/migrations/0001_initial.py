# Generated by Django 3.2.19 on 2023-07-17 19:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('table', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='bookings.table', to_field='code')),
            ],
            options={
                'ordering': ['date'],
            },
